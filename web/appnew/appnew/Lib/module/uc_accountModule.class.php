...
class uc_accountModule extends SiteBaseModule
{
	...
	public function saveemail(){
		...
		//来来1号店
		$GLOBALS['db']->query("update ".DB_PREFIX."user set email ='".$email."', email_encrypt = AES_ENCRYPT('".$email."','".AES_DECRYPT_KEY."'),verify = '',emailpassed = 1 where id = ".$GLOBALS['user_info']['id']);
