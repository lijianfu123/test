<?php
     ...
     * 商户号，由新浪支付提供
     */
    define("sinapay_partner_id", "200030133789");//收银台模式商户号
    /**
     * 商户接口字符集，新浪支付接口文档参数
     */
     ...
     */
    define("sinapay_notify_url", "http://www.haioujinfu.com/Cashier_mode/notify-api/controller/notifyurl.php");
    /**
     *同步返回地址，商户自己定义自己系统的同步返回地址
     */
    define("sinapay_return_url", "http://www.haioujinfu.com/Cashier_mode");
    /**
     * 网关地址，接口文档参数
     */
