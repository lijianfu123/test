...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <div>本页面仅在测试环境使用，可根据提示输入参数测试创建会员接口。demo使用时需要开启phpcurl扩展和openssl！，
            ...
            <h3 style="color: red">
                1,解冻余额，在资金冻结后，核算下来无异常即可解冻让用户正常对资金进行操作。
            </h3>
        </div>
    </fieldset>
    <br> <br>
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="解冻余额" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="balance_unfreeze"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        balance_unfreeze 冻结余额
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">解冻订单号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="out_unfreeze_no" name="out_unfreeze_no"
                            value="<?php echo date("YmdHis") ?>"> <br></td>
                    <td style="vertical-align: top; width: 25%;">商户网站解冻订单号，商户内部保证唯一 <br>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">原冻结订单号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="out_freeze_no" name="out_freeze_no"
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">商户网站冻结订单号，商户内部保证唯一 <br>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="UID"> <br></td>
                    <td style="vertical-align: top; width: 25%;">ID的类型，目前只包括UID <br>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">解冻金额： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="amount" name="amount"
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">解冻金额，默认为空，不填代表全额解冻 <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="交易解冻"> <br></td>
                    <td style="vertical-align: top; width: 25%;">请求摘要 <br>
                    </td>
                </tr>
...
<script>
    ...
    function checkForm() {
        ...
        var out_unfreeze_no = $("#out_unfreeze_no").val();
        if (typeof (out_unfreeze_no) != "undefined" && out_unfreeze_no) {
            params += '&out_unfreeze_no=' + out_unfreeze_no;
        } else {
            $("#error").html("请输入解冻订单号");
            return false;
        }
        var out_freeze_no = $("#out_freeze_no").val();
        if (typeof (out_freeze_no) != "undefined" && out_freeze_no) {
            params += '&out_freeze_no=' + out_freeze_no;
        } else {
            $("#error").html("请输入冻结订单号");
            return false;
        }
