...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="查询收支明细" id="test_weibopay">&nbsp;<input
        ...
        <form id="request_form" name="request_form">
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">扩展参数： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="extend_param" name="extend_param" value="svp_trade_type^in_out">
                        <br></td>
                    <td style="vertical-align: top; width: 25%;">svp_trade_type^bonus – 只返回收益,svp_trade_type^in_out –
                        返回收入和支出
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="query_account_details"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        query_account_details查询收支明细
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">开始时间： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="start_time" name="start_time"
                            value="<?php echo date("YmdHis") ?>"> <br></td>
                    <td style="vertical-align: top; width: 25%;">数字串，一共14位格式为：年[4位]月[2位]日[2位]时[2位]分[2位]秒[2位]

                        <br>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">结束时间： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="end_time" name="end_time"
                            value="<?php echo date("YmdHis") ?>"> <br></td>
                    <td style="vertical-align: top; width: 25%;">数字串，一共14位
                        格式为：年[4位]月[2位]日[2位]时[2位]分[2位]秒[2位] <br>
                    </td>
                </tr>
                <tr>
...
<script>
    ...
    function checkForm() {
        ...
        var extend_param = $("#extend_param").val();
        if (typeof (extend_param) != "undefined" && extend_param) {
