...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="经办人信息录入" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="smt_fund_agent_buy"> <br></td>
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">经办人姓名： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="agent_name" name="agent_name"
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">用户身份证姓名 非空 张三</td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">证件类型： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="license_type_code" name="license_type_code" value="ID">
                        <br></td>
                    <td style="vertical-align: top; width: 25%;">ID</td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">经办人身份证： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="license_no" name="license_no" value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">证件号码 非空
                        33001444564878899
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">经办人手机号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="agent_mobile" name="agent_mobile" value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">经办人手机号</td>
                </tr>
...
<script>
    ...
    function checkForm() {
        ...
        if (typeof (agent_name) != "undefined" && agent_name) {
        ...
        //证件类型
        var license_type_code = $("#license_type_code").val();
        if (typeof (license_type_code) != "undefined" && license_type_code) {
            params += '&license_type_code=' + license_type_code;
        } else {
            $("#error").html("请输入证件类型");
            return false;
        }
        ...
        if (typeof (agent_mobile) != "undefined" && agent_mobile) {
            params += '&agent_mobile=' + agent_mobile;
        } else {
            $("#error").html("请输入经办人手机");
            return false;
        }
