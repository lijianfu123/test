...
<div id="mainContainer">
    <h1>找回认证手机/修改认证手机重定向</h1>
    <fieldset>
        <legend> 介绍</legend>
        <div>本页面仅在测试环境使用，可根据提示输入参数测试*恩泽手机重定向接口。demo使用时需要开启phpcurl,openssl扩展！</div>
    </fieldset>
    <br> <br>
    <fieldset>
        <legend> 调用参数</legend>
        <input style="height: 40px; width: 150px;"
               type="button" value="*认证手机重定向" id="test_weibopay">&nbsp;<input
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%">
                        <select name="service" id="service">
                            <option value="modify_verify_mobile">修改认证手机重定向</option>
                            <option value="find_verify_mobile">找回认证手机重定向</option>
                        </select>
                        <br></td>
