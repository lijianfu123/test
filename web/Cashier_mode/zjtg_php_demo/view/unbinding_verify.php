...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <div>本页面仅在测试环境使用，可根据提示输入参数测试创建会员接口。demo使用时需要开启phpcurl扩展和openssl！，
            ...
            <h3 style="color: red">
                1，解绑认证信息接口，此接口用于在用户未设置支付密码前，解绑掉客户在新浪绑定的认证手机号使用，如果客户设置了支付密码后那么次接口将不支持解绑认证手机号，只能通过修改认证手机号接口实现。
            </h3>
        </div>
    </fieldset>
    <br> <br>
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="解除绑定认证信息" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="unbinding_verify"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        unbinding_verify 解除绑定认证信息
                    </td>
                </tr>
                <tr>
