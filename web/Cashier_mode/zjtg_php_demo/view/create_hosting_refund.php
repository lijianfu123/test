...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="托管交易退款" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="create_hosting_refund"> <br></td>
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">原始的商户网站唯一交易订单号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="orig_outer_trade_no" name="orig_outer_trade_no"
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">原始的钱包合作商户网站唯一订单号（确保在合作伙伴系统中唯一）。同交易中的一致。</td>
                </tr>

                <tr>
                    <td style="vertical-align: top; width: 25%;">退款金额： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="refund_amount" name="refund_amount"
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">支持部分退款，退款金额不能大于交易金额。
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 25%;">(可空)退款原因
                    </td>
                </tr>
...
<script>
    ...
    function checkForm() {
        ...
        //原始的商户网站唯一交易订单号
        var orig_outer_trade_no = $("#orig_outer_trade_no").val();
        if (typeof (orig_outer_trade_no) != "undefined" && orig_outer_trade_no) {
            params += '&orig_outer_trade_no=' + orig_outer_trade_no;
        } else {
        ...
        if (typeof (refund_amount) != "undefined" && refund_amount) {
