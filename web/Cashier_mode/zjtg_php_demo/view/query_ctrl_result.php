...
<div id="mainContainer">
    ...
    <fieldset>
        <legend> 介绍</legend>
        <div>本页面仅在测试环境使用，可根据提示输入参数测试查询冻结解冻结果接口。demo使用时需要开启phpcurl,openssl扩展！</div>
    </fieldset>
    <br> <br>
    <fieldset>
        <legend> 调用参数</legend>
        <input style="height: 40px; width: 150px;"
               type="button" value="查询冻结交易" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="query_ctrl_result"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        query_ctrl_result查询冻结解冻结果
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">冻结解冻订单号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="out_ctrl_no" name="out_ctrl_no"
                            value="20150505090759"> <br></td>
                    <td style="vertical-align: top; width: 25%;">返回入参的冻结解冻订单号</td>
                </tr>
...
<script>
    ...
    function checkForm() {
        ...
        //业务参数
        var out_ctrl_no = $("#out_ctrl_no").val();
        if (typeof (out_ctrl_no) != "undefined" && out_ctrl_no) {
            params += '&out_ctrl_no=' + out_ctrl_no;
        } else {
            $("#error").html("请输入冻结解冻订单号");
            return false;
        }
        return params;
    }
