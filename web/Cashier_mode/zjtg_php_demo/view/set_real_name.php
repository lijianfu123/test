...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <div>本页面仅在测试环境使用，可根据提示输入参数测试创建会员接口。demo使用时需要开启phpcurl扩展和openssl！，
            ...
            <h3 style="color: red">
                1，设置实名信息接口将用户的身份证证件姓名和证件号码通过此接口发送到新浪进行客户在新浪的账户的实名认证服务。
                </br>
                2，实名认证中客户证件号码如果涉及到字母的需要严格按照证件上写的大小写来进行填写，切不可将大写X写成小写x。
                </br>
                3，目前实名认证服务仅支持大陆身份证类型IC。
            </h3>
        </div>
    </fieldset>
    <br> <br>
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="设置会员实名信息" id="test_weibopay">&nbsp;<input
        ...
        <form id="request_form" name="request_form">
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">真实姓名： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="real_name" name="real_name"
                            value=""> <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="cert_type" name="cert_type" value="IC">
                        <br></td>
                    <td style="vertical-align: top; width: 25%;">目前只支持身份证 IC 身份证PP 护照
                        HMP 港澳通行证
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">证件号码： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
