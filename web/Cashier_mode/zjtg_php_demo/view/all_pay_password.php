...
<div id="mainContainer">
    ...
    <fieldset>
        <legend> 介绍</legend>
        <div>本页面仅在测试环境使用，可根据提示输入参数测试*支付密码重定向接口。demo使用时需要开启phpcurl,openssl扩展！</div>
    </fieldset>
    1，此demo集成了修改，设置，找回支付密码三个接口的范例
    <br> <br>
    <fieldset>
        <legend> 调用参数</legend>
        <input style="height: 40px; width: 150px;"
               type="button" value="*支付密码重定向" id="test_weibopay">&nbsp;<input
        ...
        <form id="request_form" name="request_form">
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="return_url" name="return_url" value="https://pay.sina.com.cn/zjtg">
                        <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%">
                        <select name="service" id="service">
                            <option value="set_pay_password">设置支付密码重定向</option>
                            <option value="modify_pay_password">修改支付密码重定向</option>
                            <option value="find_pay_password">找回支付密码重定向</option>
                        </select>
                        <br></td>
