...
<div id="mainContainer">
    ...
    <fieldset>
        <legend> 介绍</legend>
        <div>本页面仅在测试环境使用，可根据提示输入参数测试代收完成接口。demo使用时需要开启phpcurl扩展和openssl！</div>
        <h3 style="color:red;">
    </fieldset>
    <br> <br>
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value=代收完成" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="finish_pre_auth_trade"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        finish_pre_auth_trade预授权完成
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 25%;">签名方式支持RSA非空
                    </td>
                </tr>
                <!--业务参数-->
                <td colspan="3"
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">预授权请求号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="out_request_no" name="out_request_no"
                            value="<?php echo date("YmdHis") ?>"> <br></td>
                    <td style="vertical-align: top; width: 25%;">预授权请求号</td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">交易列表： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="trade_list" name="trade_list"
                            value="<?php echo date("YmdHis") ?>_fishing~12345~1.00~预授权完成~a^1|b^2$<?php echo date("YmdHis") ?>_fishing_02~123456~1.00~预授权完成~a^1|b^2">
                        <br></td>
                    <td style="vertical-align: top; width: 25%;">I详见“交易参数”。参数间用“~”分隔，各条目之间用“$”分隔，备注信息不要包含特殊分隔符<br>
                    </td>
                </tr>
...
<script>
    ...
    function checkForm() {
        ...
        if (typeof (out_request_no) != "undefined" && out_request_no) {
            params += '&out_request_no=' + out_request_no;
        } else {
            $("#error").html("请输入预授权完成请求号");
            return false;
        }
