...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="支付推进" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="advance_hosting_pay"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        advance_hosting_pay支付推进接口
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">支付推进请求号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="out_advance_no" name="out_advance_no"
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">支付推进请求号</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="validate_code" name="validate_code"
                            value=""> <br></td>
...
<script>
    ...
    function checkForm() {
        ...
        //业务参数
        var out_advance_no = $("#out_advance_no").val();
        if (typeof (out_advance_no) != "undefined" && out_advance_no) {
            params += '&out_advance_no=' + out_advance_no;
        } else {
            $("#error").html("请输入绑卡请求号");
            return false;
        }
        ...
        if (typeof (validate_code) != "undefined" && validate_code) {
