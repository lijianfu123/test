...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="创建批量托管代付交易" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="create_batch_hosting_pay_trade"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        create_batch_hosting_pay_trade创建批量托管代付交易
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="<?php echo date("YmdHis") ?>"> <br></td>
                    <td style="vertical-align: top; width: 25%;">商户网站支付订单号，商户内部保证唯一 非空 20131105154925</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 25%;">
                        交易订单号~收款人标识~标识类型~账户类型~金额~分账信息列表（付款人标识^付款人标识类型^收款人标识^收款人标识类型^金额)~摘要~扩展信息,</br>
                        参数间用“~”分隔，各条目之间用“$”分隔，备注信息不要包含特殊分隔符</br>
                        注：在交易列表中如果参数为空，均需要预留位置出来例如20131105154925~10014542~UID~BASIC~1.00~~demotest~具体参考接口文档
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%">
                        <select id="notify_method" name="notify_method">
                            <option value="single_notify">single_notify交易逐笔通知</option>
                            <option value="batch_notify">batch_notify批量通知</option>
                        </select>
                        <br></td>
