...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="查询中间账户余额" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="query_middle_account"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        query_middle_account查询中间账户余额
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">外部业务吗： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="out_trade_code" name="out_trade_code"
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">商户网站代收交易业务码，见附录。举例来说
                        查询代收投资专用户， 填写1001，代收还款金专用户，填写1002
                    </td>
                </tr>
