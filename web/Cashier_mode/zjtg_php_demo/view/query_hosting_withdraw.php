...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="托管提现查询" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="query_hosting_withdraw"> <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="start_time" name="start_time" value="<?php echo date("YmdHis") ?>">
                        <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="end_time" name="end_time" value="<?php echo date("YmdHis") ?>">
                        <br></td>
                    <td style="vertical-align: top; width: 25%;">数字串，一共14位
                        格式为：年[4位]月[2位]日[2位]时[2位]分[2位]秒[2位]
                        <br>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="page_no" name="page_no" value="1"> <br></td>
                    <td style="vertical-align: top; width: 25%;">页号，从1开始，默认为1
                        <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="page_size" name="page_size" value="20"> <br></td>
                    <td style="vertical-align: top; width: 25%;">每页记录数，默认20
                        <br>
                    </td>
                </tr>
