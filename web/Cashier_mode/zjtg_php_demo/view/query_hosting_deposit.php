...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="托管交易查询" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="query_hosting_deposit"> <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">商户系统用户id(字母或数字) 非空 2000011212</td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="UID"> <br></td>
                    <td style="vertical-align: top; width: 25%;">ID的类型，包括UID、MOBILE、EMAIL 非空 UID</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="start_time"
                            name="start_time" value="<?php echo date("YmdHis") ?>"> <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="end_time"
                            name="end_time" value="<?php echo date("YmdHis") ?>"> <br></td>
                    <td style="vertical-align: top; width: 25%;">数字串，一共14位
                        格式为：年[4位]月[2位]日[2位]时[2位]分[2位]秒[2位] 可空 20131117020101
                        <br>
                    </td>
