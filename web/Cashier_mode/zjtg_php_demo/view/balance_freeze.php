...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <div>本页面仅在测试环境使用，可根据提示输入参数测试创建会员接口。demo使用时需要开启phpcurl扩展和openssl！，
            ...
            <h3 style="color: red">
                1，用户账户余额冻结，用于冻结客户可用余额，在资金发生异常的情况下，可以先冻结。
            </h3>
        </div>
    </fieldset>
    <br> <br>
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="冻结余额" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="balance_freeze"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        balance_freeze 冻结余额
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">冻结订单号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 25%;">单位为：RMB
                        Yuan。取值范围为[0.01,1000000.00]，精确到小数点后两位。
                    </td>
                </tr>
                <tr>
