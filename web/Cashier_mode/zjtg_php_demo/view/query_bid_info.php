...
<div id="mainContainer">
    ...
    <fieldset>
        <legend> 介绍</legend>
        <div>本页面仅在测试环境使用，可根据提示输入参数测试标的信息查询接口。demo使用时需要开启phpcurl扩展和openssl！，
            <h2>测试注意事项：</h2>
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="查询标的信息" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="query_bid_info"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        query_bid_info查询标的信息
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">商户网站标的号，商户标的相关数据唯一索引
                    </td>
                </tr>
