...
<div id="mainContainer">
    ...
    <fieldset>
        <legend> 介绍</legend>
        <div>本页面仅在测试环境使用，可根据提示输入参数测试代收撤销接口。demo使用时需要开启phpcurl扩展和openssl！</div>
        <h3 style="color:red;">
    </fieldset>
    <br> <br>
    <fieldset>
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="cancel_pre_auth_trade"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        cancel_pre_auth_trade预授权撤销
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="<?php echo date("YmdHis") ?>_cancel~1443146884289~撤销1~a^1|b^2$<?php echo date("YmdHis") ?>_cancel_02~1443146884288~撤销2~a^1|b^2">
                        <br></td>
