...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="托管提现" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="create_hosting_withdraw"> <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%">
                        <select id="account_type" name="account_type">
                            <option valie="BASIC">BASIC</option>
                            <option valie="SAVING_POT">SAVING_POT</option>
                        </select>
                        <br></td>
                    <td style="vertical-align: top; width: 25%;">账户类型（基本户、存钱罐）。默认基本户，见附录<br>
                    </td>
                </tr>

                <tr>
                    <td style="vertical-align: top; width: 25%;">提现方式： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="withdraw_mode" name="withdraw_mode" value="CASHDESK"> <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="amount" name="amount" value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">单位为：RMB
                        Yuan。取值范围为[0.01,1000000.00]，精确到小数点后两位。<br>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">提现摘要： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="summary" name="summary" value="某某用户提现"> <br></td>
                    <td style="vertical-align: top; width: 25%;">提现内容摘要<br>
                    </td>
                </tr>

                <tr>
                    <td style="vertical-align: top; width: 25%;">银行卡ID： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="card_id" name="card_id" value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">用户绑定银行卡ID，即绑定银行卡返回的ID<br>
                    </td>
                </tr>
...
<script>
    ...
    function checkForm() {
        ...
        if (typeof (summary) != "undefined" && summary) {
            ...
            $("#error").html("请输入用户提现备注");
            return false;
        }
        var withdraw_mode = $("#withdraw_mode").val();
        if (typeof (withdraw_mode) != "undefined" && withdraw_mode) {
            params += '&withdraw_mode=' + withdraw_mode;
        } else {
            $("#error").html("提现方式不能为空");
            return false;
        }
