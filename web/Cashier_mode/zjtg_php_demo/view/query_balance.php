...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <div>本页面仅在测试环境使用，可根据提示输入参数测试创建会员接口。demo使用时需要开启phpcurl扩展和openssl！，
            ...
            <h3 style="color: red">
                1，一个用户存在多个账户类型，查询是区分清楚客户交易以及需要查询的是哪个账户类型。
                2，同步用户每天存钱罐的收益，通过新浪提供的sftp对账功能实现，切勿通过余额查询或者收支明细查询实现。
            </h3>
        </div>
    </fieldset>
    <br> <br>
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="查询余额" id="test_weibopay">&nbsp;<input
        ...
        <form id="request_form" name="request_form">
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 25%;">BASI 基本户 ENSURE 保证金户 SAVING_POT 存钱罐
                        <br>
                    </td>
                </tr>
