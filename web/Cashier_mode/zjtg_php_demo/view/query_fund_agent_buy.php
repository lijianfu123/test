...
<div id="mainContainer">
    ...
    <fieldset>
        <legend> 介绍</legend>
        <div>本页面仅在测试环境使用，可根据提示输入参数测试查询经办人接口。demo使用时需要开启phpcurl,openssl扩展！</div>
    </fieldset>
    <br> <br>
    <fieldset>
        <legend> 调用参数</legend>
        <input style="height: 40px; width: 150px;"
               type="button" value="查询经办人" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="query_fund_agent_buy"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        query_fund_agent_buy查询经办人
                    </td>
                </tr>
                <tr>
