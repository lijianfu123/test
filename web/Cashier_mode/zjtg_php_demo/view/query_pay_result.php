...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="支付结果查询" id="test_weibopay">&nbsp;<input style="height: 40px; width: 150px;"
                                                                            type="button" value="刷新" id="reset"> <br/>
