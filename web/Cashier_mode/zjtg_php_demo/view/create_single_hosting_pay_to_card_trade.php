...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="创建单笔代付到提现卡" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="http://10.65.106.26/create_single_hosting_pay_to_card_trade/controller/notifyurl.php">
                        <br></td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="create_single_hosting_pay_to_card_trade"> <br></td>
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">收款方式： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="collect_method"
                            name="collect_method" value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">
                        格式：收款方式^扩展。扩展信息内容以“，”分隔，收款方式及扩展详见附录，binding_card^10014543,UID,5446010
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            name="amount" value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">金额</td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">摘要： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="summary"
                            name="summary" value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">摘要</td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">标的号： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">债权变动明细列表： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="creditor_info_list"
                            name="creditor_info_list" value=""> <br></td>
...
<script>
    ...
    function checkForm() {
        ...
        //收款方式
        var collect_method = $("#collect_method").val();
        if (typeof (collect_method) != "undefined" && collect_method) {
            params += '&collect_method=' + collect_method;
        } else {
            $("#error").html("请输收款方式");
            return false;
        }
