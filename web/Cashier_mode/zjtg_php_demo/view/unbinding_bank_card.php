...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="解除绑定银行卡" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="unbinding_bank_card"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        unbinding_bank_card解除绑定银行卡
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="vertical-align: top; width: 25%;">卡ID： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="card_id" name="card_id"
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">钱包系统卡ID，绑卡返回的ID 非空</td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">是否推进： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                            style="width: 100%;" id="advance_flag" name="advance_flag"
                            value="Y"> <br></td>
                    <td style="vertical-align: top; width: 25%;">是否推进接口 Y</td>
                </tr>
...
<script>
    ...
    function checkForm() {
        ...
        if (typeof (advance_flag) != "undefined" && advance_flag) {
            params += '&advance_flag=' + advance_flag;
        } else {
            $("#error").html("请输入是否推进 ");
            return false;
        }
