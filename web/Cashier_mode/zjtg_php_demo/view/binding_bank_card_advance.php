...
<div id="mainContainer">
    ...
    <fieldset>
        ...
        <input style="height: 40px; width: 150px;"
               type="button" value="绑定银行卡推进" id="test_weibopay">&nbsp;<input
            ...
            <table style="text-align: left; width: 100%; font-size: 12px;"
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value="binding_bank_card_advance"> <br></td>
                    <td style="vertical-align: top; width: 25%;">接口名称 非空
                        binding_bank_card_advance绑定银行卡推进接口
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; width: 25%;">绑卡时返回的ticket： <br>
                    </td>
                    <td style="vertical-align: top; width: 50%"><input
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 50%"><input
                            ...
                            value=""> <br></td>
                    <td style="vertical-align: top; width: 25%;">用户绑卡手机收到的验证码</td>
                </tr>
